...
export default function AppSidebar({ logoutComponent }: Props) {
                ...
                >
                  <Avatar className="h-8 w-8 rounded-lg">
                    ...
                    <AvatarFallback className="rounded-lg">
                      {session?.identity?.traits.name.first.charAt(0).toUpperCase()}{session?.identity?.traits.name.last.charAt(0).toUpperCase()}
                    </AvatarFallback>
                  </Avatar>
                  <div className="grid flex-1 text-left text-sm leading-tight">
